...
# def startvideofeed():
#     # Video feed
#     video = cv2.VideoCapture("https://192.168.137.60:8080/video")
#
#     # Setting width and height for video feed
#     video.set(3, 640)
#     video.set(4, 480)
...
def startimagefeed():
    # Video feed
    video = cv2.VideoCapture("https://192.168.137.249:8080/video")
    # Setting width and height for video feed
    video.set(3, 640)
    video.set(4, 480)
